...
| 페이지 | 경로 | 상태 |
|--------|------|------|
| 대시보드 | / | ✅ 토스 스타일, 예산 진행률, 고정비 |
| 지출 상세 | /expenses | ✅ 정렬, 21카테고리, 모바일 카드뷰 |
| 분석 | /analytics | ✅ 인사이트, TOP 5, 트렌드, 고정비 |
| 수입/저축 | /income | ✅ 편집, 7개 수입 유형, 저축률 바 |
| 할부 | /installments | ✅ 월별 계산, 진행률, 완료 토글 |
| 업로드 | /upload | ✅ 드래그앤드롭, 현대/국민카드 자동 감지 |
| 설정 | /settings | ✅ 카테고리 규칙, 예산, 부제 변경 |
| 로그인 | /login | ✅ 공유 비밀번호 |
